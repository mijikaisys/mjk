...
local baseSphereRadius = 15 -- Rayon de base de la sphère de détection
...
while true do
    ...
    if ball then
        ...
        if isPlayerTarget(ball) then
            ...
            local dynamicRadius = baseSphereRadius + ((ballVelocity.magnitude * 0.5) - distanceToBall)) -- Calculer le rayon dynamique
